...
В этом случае, следующий код не скомпилируется:
...
На самом деле, такое можно делать даже с литералами-объектами:
...
Как результат, литералы могут представлять собой специфичный "тип данных" в TS - некое обобщение String Literal Type для различных литеральных значений.
